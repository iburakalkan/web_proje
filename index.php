                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_4">Fiyat Listesi</a>
                            </li>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <h1 class="text-white mb-lg-3 mb-4"><strong>Berber </strong></h1>
                                        <p class="text-black">sizin için en profesyonel saç kesimi</p>
                                        <br>
                                        <a class="btn custom-btn custom-border-btn custom-btn-bg-white smoothscroll me-2 mb-2" href="#section_2">hakkımızda</a>

                                        <a class="btn custom-btn smoothscroll mb-2" href="#section_3">hizmetler</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8 col-12">
                                    <div class="price-list-thumb-wrap">
                                        <div class="mb-4">
                                            ...
                                            <strong>260 ₺'den başlayan fiyatlar</strong>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <p class="text-white d-flex mb-1">
                                        <a href="tel: +90 530 123 45 67" class="site-footer-link">
                                            +90 530 123 45 67
                                    ...
                                    <p class="text-white d-flex">
                                        <a href="mailto:ibrahimburakalkan@gmail.com" class="site-footer-link">
                                            ibrahimburakalkan@gmail.com
                                        </a>
                                    </p>
                ...
                <footer class="site-footer">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12">
                                <h4 class="site-footer-title mb-4"> Şubelerimiz </h4>
                            </div>

                            <div class="col-lg-4 col-md-6 col-11">
                                <div class="site-footer-thumb">
                                    <strong class="mb-1">Rıhtım Caddesi</strong>

                                    <p>Rıhtım Cad. No:1, 34716 Kadıköy/İstanbul</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 col-11">
                                <div class="site-footer-thumb">
                                    <strong class="mb-1">İstiklal Caddesi</strong>

                                    <p>İstiklal Cad. No:256, 34435 Beyoğlu/İstanbul</p>
                                </div>
                            </div>

                            <div class="col-lg-4 col-md-6 col-11">
                                <strong class="mb-1">Cumhuriyet Caddesi</strong>

                                <p>Cumhuriyet Cad. No:123, 34400 Beyoğlu/İstanbul</p>
                            </div>
                        </div>
                    </div>
